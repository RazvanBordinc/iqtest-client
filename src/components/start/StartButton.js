...
export default function StartButton({ showButton }) {
    ...
    >
      <Link href="/start" passHref>
        ...
        >
          ...
          <motion.button
            className="bg-black text-white px-8 py-4 rounded-full text-xl font-bold flex items-center justify-center gap-3 relative overflow-hidden"
            whileHover={{
              scale: 1.05,
          ...
          >
            ...
            <motion.div className="absolute inset-[2px] bg-black rounded-full z-10" />
